...
-- Select All employees born btw 1952 and 1955
SELECT first_name, last_name
FROM employees
WHERE birth_date BETWEEN '1952-01-01' AND '1955-12-31';

-- Select All employees born in 1952, 53, 54, 55
...
-- Join departments and dept manager using aliases
SELECT d.dept_name,
     dm.emp_no,
     dm.from_date,
     dm.to_date
...
-- Get Current Employees who are retirement eligible
SELECT ri.emp_no,
    ri.first_name,
    ri.last_name,
de.to_date
